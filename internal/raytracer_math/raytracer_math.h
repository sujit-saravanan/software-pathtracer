...
namespace Raytracer::Math {
        ...
        using Vec3i8 = BasicVec3<int32_t>;
        using Vec3i16 = BasicVec3<int32_t>;
        using Vec3i32 = BasicVec3<int32_t>;
        using Vec3i64 = BasicVec3<int32_t>;
        using Vec3u = BasicVec3<uint32_t>;
        using Vec3u8 = BasicVec3<uint32_t>;
        using Vec3u16 = BasicVec3<uint32_t>;
        using Vec3u32 = BasicVec3<uint32_t>;
        using Vec3u64 = BasicVec3<uint32_t>;
        ...
        using Vec2i8 = BasicVec2<int32_t>;
        using Vec2i16 = BasicVec2<int32_t>;
        using Vec2i32 = BasicVec2<int32_t>;
        using Vec2i64 = BasicVec2<int32_t>;
        using Vec2u = BasicVec2<uint32_t>;
        using Vec2u8 = BasicVec2<uint32_t>;
        using Vec2u16 = BasicVec2<uint32_t>;
        using Vec2u32 = BasicVec2<uint32_t>;
        using Vec2u64 = BasicVec2<uint32_t>;
